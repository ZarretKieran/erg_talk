...
Platform-agnostic TypeScript library for interfacing with the Concept2 PM5 ergometer via Bluetooth Low Energy. Handles CSAFE protocol framing, workout programming, and real-time data streaming.
